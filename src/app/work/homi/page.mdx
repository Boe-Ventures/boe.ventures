...
export const caseStudy = {
  ...
  summary: [
    ...
    'I built Homi on a modern tech stack: Next.js, TypeScript, and tRPC. The platform launched with 250+ organic signups, secured broker pilots, and achieved first MRR within months of launch.',
  ],
  logo,
  image: { src: imageHero },
  date: '2024-08',
